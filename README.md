...
6. [LDL-AURIS](#6-ldl-auris)
   ...
   6.2.1. [Forced Alignment Script](#621-forced-alignment-script-scriptsforced_alignmentpy)
   
   6.2.2. [Extract Word Audio Script](#622-extract-word-audio-script-scriptsextract_word_audiopy)
   
   6.2.3. [Mask Word Audio Script](#623-mask-word-audio-script-scriptsmask_word_audiopy)
...
7. [SLURM Processing](#7-slurm-processing)
   ...
   7.7. [Mask Word Audios](#77-mask-word-audios-mask_word_audiosbatch)
